...
x_range = np.arange(range_start, range_end - step_size, step_size)

# known_points = [(2, 0.6469411338530017), (4, -0.014540320008636365), (6, 1.0026340815636092), (8, 0.5727168458105834)]
known_points = []
for x in x_range:
    point = (x, f(x))
    known_points.append(point)
p, p_string = interpolation_polynomial(known_points, get_string=True)
results = []
for x in x_range:
    temp = p(x)
    results.append(temp)
